...
<!-- *****************************************TOP&NAV**********************************************************-->
      ...
      <div class="nav-collapse collapse">
            ...
            <a class="dropdown-toggle mains active" data-toggle="dropdown" href="#" role="button" aria-expanded="false">
                                    <i class="fa fa-user-plus fa-lg"></i><br />Login
                                    </a>
       ...
       <!-- Page Title -->
        <div class="page-title">
            <div class="container">
                <div class="row">
                    <div class="span12">
                        <i class="fa fa-user-plus page-title-icon" ></i>
                        <h2>Acceso a tu cuenta/</h2>
                        <p>Valida tu ingreso a tu cuenta</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="contact-us container">
            <div class="row">
                <div class="contact-form span7">
                    <form method="post" class="validator" action="lib/ops_login/loginValidar.php">
                        <label for="user"> <i class="fa fa-at"></i>&nbsp; E-Mail:</label>
                          <input id="user" type="email" name="cor_cliente" 
                ...
                <div class="contact-form span5">
                    <img class="img_admin"src="herramientas/img/social-icons/admin.png">
