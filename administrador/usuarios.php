...
<?php } ?>   
				    ...
				    <li>
                        <a  class="active" href="usuarios.php"><i class="fa fa-user-plus fa-3x"></i>&nbsp; Usuarios</a>
                    </li>	
                     </ul>
            </div>
        </nav>
            ...
            <div id="page-inner">
                <div class="row orion">
                 ...
                 <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal5">
                             ...
                             <a href="formu_Usuarios.php" class="btn btn-success btn-sm" role="button">
                                 Nuevo Usuario&nbsp;<i class="fa fa-file-o fa-x"></i>
                             </a>
                </div>
                </div>              
                <div class="row">
...
while($data=$dataCli->fetchObject())
{
                        echo "<tr class='odd gradeX'>";
                            echo "<td>" . $data->id_Cliente . "</td>";
                            echo "<td>" . $data->nom_cliente . "</td>";
                            echo "<td>" . $data->cor_cliente . "</td>";
                            echo "<td>" . $data->tel_cliente . "</td>";
                            echo "<td>" . $data->dir_cliente . "</td>";
                            echo "<td>" . $data->pass_cliente. "</td>";
                            echo "<td>" . $data->niv_cliente. "</td>";
                            echo "<td>" . $data->estado_cliente. "</td>";
                            echo "<td> <form name='F-update' action='formu_Usuarios.php' method='post'>
                            ...
                            echo "<td> <form name='F-delete' class='validator'action='../lib/ops_usuarios/deleteUsuario.php' method='post'>
                                 <input type='hidden' name='id' value='".$data->id_Cliente."'>
...
&nbsp;Esta seccion no contiene nigun elemento <a href="formu_Usuarios.php" class="alert-link">Ingresa un elemento aqui</a>&nbsp;
<i class="fa fa-exclamation-circle fa-2x "></i>
</div>                                                                   
 <?php } ?>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Con esta sección usted puede administrar cuantas personas pueden acceder 
                                        como usuarios y administradores, esto con el fin de mantener un 
                                        mejor control sobre la seguridad del sitio.
                                        </div>
