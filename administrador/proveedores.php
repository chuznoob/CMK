				...
				<li class="text-center">
                    <img src="../herramientas/img/find_user.png" class="user-image img-responsive"/>
                     ...
                     <li>
                      ...
                      <li>
                        <a class="active" href="proveedores.php"><i class="fa fa-users fa-3x"></i>&nbsp; Proveedores</a>
                    </li>
                     <li>
            ...
            <div class="row orion">
                ...
                <div class="col-md-3"> 
                 <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal5">
                             ...
                             <a href="formu_Proveedores.php" class="btn btn-success btn-sm" role="button">
                                 Nuevo Proveedor&nbsp;<i class="fa fa-file-o fa-x"></i>
                             </a>
                </div>
            </div>
                 <div class="row">
                  <div class="col-md-12 "> 
<?php if($dataProv!=null){ ?>
                            <!-- Advanced Tables -->
...
while($data=$dataProv->fetchObject())
{
                        echo "<tr class='odd gradeX'>";
                            echo "<td>" . $data->id_proveedor . "</td>";
                            echo "<td>" . $data->em_proveedor . "</td>";
                            echo "<td>" . $data->cont_proveedor . "</td>";
                            echo "<td>" . $data->tel_proveedor . "</td>";
                            echo "<td>" . $data->cor_proveedor. "</td>";
                            echo "<td>" . $data->dir_proveedor. "</td>";
                            echo "<td> <form name='F-update' action='formu_Proveedores.php' method='post'>
                                 <input type='hidden' name='id' value='".$data->id_proveedor."'>
                                 <button type='submit' class='btn btn-warning btn-sm'><i class='fa fa-pencil-square-o fa-2x'></i></button>
                                 </form>
                                 </td>";
                            echo "<td> <form name='F-delete' class='validator'action='../lib/ops_proveedores/deleteProveedor.php' method='post'>
                                 <input type='hidden' name='id' value='".$data->id_proveedor."'>
...
&nbsp;Esta seccion no contiene nigun elemento <a href="formu_Proveedores.php" class="alert-link">Ingresa un elemento aqui</a>&nbsp;
<i class="fa fa-exclamation-circle fa-2x "></i>
</div>                                                                   
 <?php } ?>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                          En esta sección usted podrá realizar altas, bajas y modificaciones de sus 
                                        proveedores, esto le permitirá mantener una mejor organización así como un 
                                        control de sus actuales proveedores, así mismo le permitirá observar de 
                                        manera  más simple a cada uno de ellos. Si el Proveedor está siendo usada por un                                         producto este no podrá ser borrado.
                                        </div>
