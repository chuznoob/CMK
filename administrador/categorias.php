            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a  class="active" href="categorias.php"><i class="fa fa-tags fa-3x"></i>&nbsp; Categorias</a>
                    </li>
                    <li>
                     ...
                     <h2 id="one">Panel de categorias</h2>   
                        <h5>En esta pantalla usted podrá organizar y administrarlas categorias en las que se dividen los productos.</h5>
                         ...
                         <button class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal5">
                                     ...
                                     <a href="formu_Categorias.php" class="btn btn-success btn-sm" role="button">
                                         Nueva Categoría&nbsp;<i class="fa fa-file-o fa-x"></i>
                                     </a>
                        </div>
                </div>              
...
while($data=$dataCat->fetchObject())
{
                        echo "<tr class='odd gradeX'>";
                            echo "<td>" . $data->id_Categoria . "</td>";
                            echo "<td>" . $data->nom_categoria . "</td>";
                            echo "<td>" . $data->desc_categoria . "</td>";
                            echo "<td> <form name='F-update' action='formu_Categorias.php' method='post'>
                                 <input type='hidden' name='id' value='".$data->id_Categoria."'>
                                 <button type='submit' class='btn btn-warning btn-sm'><i class='fa fa-pencil-square-o fa-2x'></i></button>
                                 </form>
                                 </td>";
                            echo "<td> <form name='F-delete' class='validator' action='../lib/ops_categoria/deleteCategoria.php' method='post'>
                                 <input type='hidden' name='id' value='".$data->id_Categoria."'>
...
&nbsp;Esta seccion no contiene nigun elemento <a href="formu_Categorias.php" class="alert-link">Ingresa un elemento aqui</a>&nbsp;
<i class="fa fa-exclamation-circle fa-2x "></i>
</div>                                                                   
 <?php } ?>
                    ...
                    <div class="modal fade" id="myModal5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        categorias, esto le permitirá mantener una mejor organización así como un 
                                        control de sus productos. Si la categoría está siendo usada por un producto esta                                         no podrá ser borrada
                                        </div>
