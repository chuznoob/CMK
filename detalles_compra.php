<?php
session_start();
include_once 'lib/class/User_ProVent_detalle.php';
...
$classUPVD = new User_ProVent_detalle();
...
<?php }
    ?>
      ...
      <div class="nav-collapse collapse">
            ...
            data-trigger="focus" 
            data-content="
            <a class='btn btn-default btn-md'href='compras.php'> <i class='fa fa-reply'></i>&nbsp;Regresar</a>
            <a class='btn btn-default btn-md'href='login.php'> <i class='fa fa-user-times'></i>&nbsp;Salir</a>"
            data-placement="bottom" 
            href="#" role="button" aria-expanded="false">
            <i class="fa fa-search fa-lg"></i><br/>Detalles
            </a> 
                                 </li>
                                </ul>
                            </div>
       ...
       <!-- Page Title -->
        <div class="page-title">
            <div class="container">
                <div class="row">
                    <div class="span12">
                        <i class="fa fa-search page-title-icon" ></i>
                        <h2>Detalles/</h2>
                        <p>Consulta las especificaciones de tu compra    </p>
                    </div>
                </div>
            </div>
        </div>
